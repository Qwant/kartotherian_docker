#!/bin/bash
# script adapted from https://raw.githubusercontent.com/openmaptiles/import-water/master/import-water.sh
set -o errexit
set -o pipefail
set -o nounset

readonly IMPORT_DATA_DIR='/import'
...
function exec_psql() {
    psql -Xq -h $host -U $user -d $database
}
